...
// Package forkid implements EIP-2124 (https://eipssoroschain.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Soros fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Soros fork ID from an existing chain instance.
