...
// Package state provides a caching layer atop the Soros state trie.
package state
...
// StateDB structs within the soros protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/Daimon-Security/soros/pull/16485#issuecomment-380438527),
