...
pruning. Remember don't start the Gsorwithout deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gsor snapshot prune-state --help" for more details.
`
