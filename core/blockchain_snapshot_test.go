...
// It can be used for testing that restart Gsornormally.
...
// It can be used for testing that restart Gsorafter the crash.
...
// Tests a Gsorrestart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gsorwas crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gsorwas crashed and restarts with a broken snapshot. In this case
...
// Tests a Gsorwas running with snapshot enabled. Then restarts without
...
// Tests the Gsorwas running with snapshot enabled and resetHead is applied.
...
// Tests the Gsorwas running with a complete snapshot and then imports a few
