...
// ecrecover extracts the Soros account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Soros address
...
// Soros testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Soros address of the signing key
...
// Author implements consensus.Engine, returning the Soros address recovered
