...
// mapped from textual names used in the tests below to actual Soros private
...
// address retrieves the Soros address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Soros address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/Daimon-Security/soros/issues/17593). Whilst this
