...
// all blocks' seal as valid, though they still have to conform to the Soros
// consensus rules.
...
// still have to conform to the Soros consensus rules.
...
// they still have to conform to the Soros consensus rules.
