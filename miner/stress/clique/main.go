...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Soros, error) {
	// Define the basic configurations for the Soros node
	...
	// Start the node and configure a full Soros node on it
