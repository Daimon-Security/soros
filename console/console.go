...
import (
	...
	"github.com/Daimon-Security/soros/internal/jsre"
	"github.com/Daimon-Security/soros/internal/jsre/deps"
	"github.com/Daimon-Security/soros/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Soros requests through
...
// Welcome show summary of current Gsorinstance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the GsorJavaScript console!\n\n"

	// Print some generic Gsormetadata
