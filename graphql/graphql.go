...
// Package graphql provides a GraphQL interface to Soros node data.
package graphql
...
// Account represents an Soros account at a particular block.
type Account struct {
...
// Transaction represents an Soros transaction.
...
// Block represents an Soros block.
...
type CallData struct {
	From                 *common.Address // The Soros address the call is from.
	To                   *common.Address // The Soros address the call is to.
