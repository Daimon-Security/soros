...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsor.ipc", false, filepath.Join(os.TempDir(), "gsor.ipc")},
		{"data", "gsor.ipc", false, "data/gsor.ipc"},
		{"data", "./gsor.ipc", false, "./gsor.ipc"},
		{"data", "/gsor.ipc", false, "/gsor.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsor.ipc", true, `\\.\pipe\gsor.ipc`},
		{"data", "gsor.ipc", true, `\\.\pipe\gsor.ipc`},
		{"data", `\\.\pipe\gsor.ipc`, true, `\\.\pipe\gsor.ipc`},
	}
