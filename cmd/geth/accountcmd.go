...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Soros presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gsor wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Soros presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gsor wallet [options] /path/to/my/presale.wallet
...
between soros nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gsor account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gsor account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another soros instance,
