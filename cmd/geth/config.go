...
import (
	...
	"github.com/Daimon-Security/soros/accounts/external"
	"github.com/Daimon-Security/soros/accounts/keystore"
	"github.com/Daimon-Security/soros/accounts/scwallet"
	"github.com/Daimon-Security/soros/accounts/usbwallet"
	"github.com/Daimon-Security/soros/cmd/utils"
	"github.com/Daimon-Security/soros/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gsor.ipc"
	return cfg
}

// makeConfigNode loads gsor configuration and creates a blank node instance.
...
// makeFullNode loads gsor configuration and creates the Soros backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the Soros Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
