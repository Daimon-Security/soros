...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale soros state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
gsor snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gsor snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
gsor snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
gsor snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gsor dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gsor dump', but uses the snapshots
