...
import (
	...
	"github.com/Daimon-Security/soros/internal/utesting"
...
func TestEthSuite(t *testing.T) {
	gsor, err := runGeth()
	if err != nil {
		t.Fatalf("could not run gsor: %v", err)
	}
	defer gsor.Close()

	suite, err := NewSuite(gsor.Server().Self(), fullchainFile, genesisFile)
	if err != nil {
...
// runGeth creates and starts a gsor node
