...
// setting up a new or managing an existing Soros private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Soros private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Soros network down to  |")
	...
	log.Info("Administering Soros network", "name", w.network)
