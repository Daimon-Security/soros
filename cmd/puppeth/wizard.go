...
type wizard struct {
	...
	services map[string][]string   // Soros services known to be running on servers
...
// converts it to an Soros address. If an empty line is entered, the default
// value is returned.
