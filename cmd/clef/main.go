...
import (
	...
	"github.com/Daimon-Security/soros/signer/core"
	"github.com/Daimon-Security/soros/signer/core/apitypes"
	"github.com/Daimon-Security/soros/signer/fourbyte"
	"github.com/Daimon-Security/soros/signer/rules"
	"github.com/Daimon-Security/soros/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Soros account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/Daimon-Security/soros/issues/20123
