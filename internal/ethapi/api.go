...
import (
	...
	"github.com/Daimon-Security/soros/accounts/scwallet"
	...
	"github.com/Daimon-Security/soros/consensus/misc"
	"github.com/Daimon-Security/soros/core"
	"github.com/Daimon-Security/soros/core/state"
...
// PublicEthereumAPI provides an API to access Soros related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Soros protocol API.
...
// Sign calculates an Soros ECDSA signature for:
...
//
// https://github.com/Daimon-Security/soros/wiki/Management-APIs#personal_sign
...
//
// https://github.com/Daimon-Security/soros/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != crypto.SignatureLength {
		return common.Address{}, fmt.Errorf("signature must be %d bytes long", crypto.SignatureLength)
	}
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, fmt.Errorf("invalid Soros signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and gsor.
...
// PublicBlockChainAPI provides an API to access the Soros blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Soros blockchain API.
...
// PublicDebugAPI is the collection of Soros APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Soros APIs exposed over the private
// debugging endpoint.
