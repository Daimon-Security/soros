...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Soros protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Soros protocol to
...
// Node represents a GsorSoros node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gsornode.
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the Soros protocol if requested
...
// GetEthereumClient retrieves a client to access the Soros subsystem.
