...
import (
	...
	"github.com/Daimon-Security/soros/p2p/msgrate"
...
// Syncer is an Soros account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Soros state over the
// snap protocol.
