...
import (
	...
	chainParams "github.com/Daimon-Security/soros/params"
	"github.com/Daimon-Security/soros/rpc"
	"github.com/Daimon-Security/soros/trie"
)

// Register adds catalyst APIs to the node.
func Register(stack *node.Node, backend *eth.Soros) error {
...
func newConsensusAPI(eth *eth.Soros) *consensusAPI {
