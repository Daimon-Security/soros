...
# 1. install gsor for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gsor
# 5. create gsor, attach and uninstall start menu entries
...
!define GROUPNAME "Soros"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Soros protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gsor is installed global
