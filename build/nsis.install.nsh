Name "gsor ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/Daimon-Security/soros/issues"
!define UPDATEURL "https://github.com/Daimon-Security/soros/releases"
!define ABOUTURL "https://github.com/Daimon-Security/soros#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsor.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsor.exe" "attach"
  ...
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gsor.ipc"
